...
export default function AdminTarifsPeriodesPage() {
  ...
  useEffect(() => {
    if (authChecked) loadPeriods();
  }, [authChecked, loadPeriods]);
        ...
        <div className="mb-6 rounded-3xl bg-white p-6 shadow">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className="text-sm font-semibold text-[#082f3a]">
              ...
              <input type="number" step="any" value={discount} onChange={(e) => setDiscount(e.target.value)} placeholder="Ex. 10 (laisser vide si aucune)" className="mt-1 w-full rounded-xl border border-[#eadfce] px-4 py-2 text-[#082f3a] outline-none focus:border-[#082f3a]" />
            </label>
